...
export const PlaceholderView: React.FC<PlaceholderViewProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#1e293b] rounded-[24px] p-6 sm:p-10 border border-[#e5e7eb] dark:border-slate-800 text-center max-w-xl mx-auto transition-colors">
      ...
      <h2 className="text-xl sm:text-2xl font-black text-[#112220] dark:text-slate-100 mb-2">
        {calculator.name} 출시 준비 중
      </h2>

      <p className="text-sm text-[#475569] dark:text-slate-400 mb-6 leading-relaxed">
        {calculator.description}
      </p>

      {/* 준비 중인 기능 안내 박스 */}
      <div className="bg-slate-50 dark:bg-slate-900 border border-[#e5e7eb] dark:border-slate-700 rounded-xl p-4 mb-6 text-left text-xs sm:text-sm space-y-2">
        <div className="font-bold text-[#112220] dark:text-slate-200 flex items-center gap-1.5">
