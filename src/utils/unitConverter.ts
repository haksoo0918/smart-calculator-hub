...
export const UNITS_DATA: Record<UnitCategory, UnitDefinition[]> = {
  area: [
    ...
    { id: 'sqcm', name: '제곱센티미터', symbol: '㎠', category: 'area', ratioToBase: 0.0001 },
    { id: 'sqkm', name: '제곱킬로미터', symbol: '㎢', category: 'area', ratioToBase: 1_000_000 },
    { id: 'ha', name: '헥타르', symbol: 'ha', category: 'area', ratioToBase: 10_000, description: '토지/농지 면적 (10,000㎡)' },
    { id: 'ac', name: '에이커', symbol: 'ac', category: 'area', ratioToBase: 4046.8564224, description: '영미권 토지 단위' },
    { id: 'sqft', name: '제곱피트', symbol: 'ft²', category: 'area', ratioToBase: 0.09290304, description: '미국/캐나다 주거 면적' },
    { id: 'sqyd', name: '제곱야드', symbol: 'yd²', category: 'area', ratioToBase: 0.83612736 },
  ],
  length: [
    { id: 'cm', name: '센티미터', symbol: 'cm', category: 'length', ratioToBase: 0.01, isPopular: true },
    { id: 'm', name: '미터', symbol: 'm', category: 'length', ratioToBase: 1, isPopular: true, description: '국제 표준 길이 단위' },
    { id: 'km', name: '킬로미터', symbol: 'km', category: 'length', ratioToBase: 1000, isPopular: true },
    { id: 'mm', name: '밀리미터', symbol: 'mm', category: 'length', ratioToBase: 0.001 },
    ...
    { id: 'mi', name: '마일', symbol: 'mi', category: 'length', ratioToBase: 1609.344, description: '도로 주행 거리 (약 1.609km)' },
    { id: 'cheok', name: '자 (척)', symbol: '尺', category: 'length', ratioToBase: 0.30303, description: '한국 전통 (10/33m ≈ 30.3cm)' },
  ],
  weight: [
    { id: 'g', name: '그램', symbol: 'g', category: 'weight', ratioToBase: 1, isPopular: true },
    { id: 'kg', name: '킬로그램', symbol: 'kg', category: 'weight', ratioToBase: 1000, isPopular: true, description: '국제 표준 질량 단위' },
    { id: 'ton', name: '톤', symbol: 't', category: 'weight', ratioToBase: 1_000_000, isPopular: true },
    { id: 'mg', name: '밀리그램', symbol: 'mg', category: 'weight', ratioToBase: 0.001 },
    ...
    { id: 'geun', name: '근 (고기)', symbol: '근', category: 'weight', ratioToBase: 600, isPopular: true, description: '한국 전통 (육류 1근 = 600g)' },
  ],
  volume: [
    { id: 'ml', name: '밀리리터', symbol: 'mL', category: 'volume', ratioToBase: 0.001, isPopular: true },
    { id: 'l', name: '리터', symbol: 'L', category: 'volume', ratioToBase: 1, isPopular: true, description: '음료, 주유 기준 단위' },
    { id: 'cbm', name: '세제곱미터', symbol: '㎥', category: 'volume', ratioToBase: 1000, description: '화물, 수도 계량 (1,000L)' },
    { id: 'gal', name: '갤런 (US)', symbol: 'gal', category: 'volume', ratioToBase: 3.785411784, isPopular: true, description: '미국 액량 갤런 (약 3.785L)' },
    { id: 'bbl', name: '배럴 (원유)', symbol: 'bbl', category: 'volume', ratioToBase: 158.987294928, description: '국제 원유 거래 (약 159L)' },
    { id: 'floz', name: '플루이드 온스', symbol: 'fl oz', category: 'volume', ratioToBase: 0.0295735295625, description: '음료 캔/향수 (약 29.57mL)' },
  ],
  temperature: [
    { id: 'celsius', name: '섭씨', symbol: '℃', category: 'temperature', ratioToBase: 1, isPopular: true, description: '물 어는점 0℃, 끓는점 100℃' },
    { id: 'fahrenheit', name: '화씨', symbol: '℉', category: 'temperature', ratioToBase: 1, isPopular: true, description: '미국 일상 기온 체계' },
